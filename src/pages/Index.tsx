      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-blue-500 to-violet-600 hover:from-blue-600 hover:to-violet-700 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-110 flex items-center gap-2 mx-auto animate-fade-in shadow-lg hover:shadow-2xl"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className={`bg-gradient-to-br ${isDarkMode ? 'from-gray-800 to-gray-700' : 'from-blue-50 to-blue-100'} rounded-lg overflow-hidden border ${borderColor} ${borderHover} transition-all duration-300 hover:transform hover:scale-105 animate-fade-in`}>
              <div className="h-64 bg-gradient-to-br from-blue-500 to-violet-600 flex items-center justify-center">
                <div className="text-center">
                  <h3 className="text-3xl font-bold text-white mb-2">Chithha</h3>
            ...
            <div className={`bg-gradient-to-br ${isDarkMode ? 'from-gray-800 to-gray-700' : 'from-violet-50 to-violet-100'} rounded-lg overflow-hidden border ${borderColor} ${borderHover} transition-all duration-300 hover:transform hover:scale-105 animate-fade-in`} style={{ animationDelay: '0.3s' }}>
              <div className="h-64 bg-gradient-to-br from-violet-500 to-blue-600 flex items-center justify-center">
                <div className="text-center">
